<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="map.aspx.vb" Inherits="homesomee.map" %>
...
&nbsp; 
 <asp:HyperLink ID="HyperLink1" runat="server" Target="_blank">Google地圖連結</asp:HyperLink>
...
<div id="map" style="height: 500px; width: 96%; margin-top: 10px;"></div>
...
<div id="map1" style="height: 500px; width: 96%;"></div>
<div>
