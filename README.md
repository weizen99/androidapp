...
===========================================================================================================
🏆 【Zen AI 股票戰情室 Pro - 四大圖表同步聯動視覺實戰指南】
===========================================================================================================
📊 核心看盤架構：
本儀表板採用「四圖上下游標 100% 同步聯動」技術，將「價格型態 ➔ 五維能量 ➔ OBV量能(採多空淨額法,但一字漲跌停完全計入) ➔ 籌碼與總分共振」
融合於同一頁面，幫助操盤手在 3 秒內精確抓出「大戶資金 ✕ 技術動能」同頻爆發的黃金買賣點！
-----------------------------------------------------------------------------------------------------------
📌 【圖一】日 K 棒防守線 ✕ 三級點火金星 ✕ 扣抵窗口 (主圖)
-----------------------------------------------------------------------------------------------------------
1. 陰陽日 K 棒與五條均線：
   • 陽線 (漲 / 紅K)：鮮豔大紅，呈現開低走高之多頭實體與上下影線。
   • 陰線 (跌 / 綠K)：螢光亮綠，呈現開高走低之空頭實體與上下影線。
   • 五條均線：5MA (綠線) | 20MA月線 (紅線) | 60MA季線 (紫線) | 120MA半年線 (藍線) | 240MA年線 (黃線)。
2. ⭐ 三級點火金星燈號 (價格突破訊號)：
   • ⭐ 黃星【短線轉強星】：收盤價強勢突破 5MA ➔ 🌤️ 短線止跌轉強，可建立試水溫部位。
   • 🌟 橘星【月線攻擊星】：收盤價強勢突破 20MA (月線) ➔ 🔥 中線波段發動，主力準備拉升。
   • ✨ 紫光大金星【三線爆發星】：收盤價強勢突破 60MA (季線/生命線) 或 同時站上 5MA+20MA+60MA ➔ 💥 均線糾結後的大波段主升段起漲！
3. 扣抵三角形標記 (5日/20日/60日扣抵)：
   • 綠色/粉色/藍色三角形標示當前均線扣抵位置，預判未來均線走勢是「扣低助漲」還是「扣高下壓」。
-----------------------------------------------------------------------------------------------------------
🌈 【圖 1.5】五維金叉彩虹共振堆疊圖 (40分滿格能量場)
-----------------------------------------------------------------------------------------------------------
直接嵌入【圖一】正下方作為獨立 200px 附圖子網格，將全市場最核心的 5 大金叉數據進行「五色彩虹堆疊」：
   1. 🟦 價格金叉 (藍色)：成交價黃金交叉次數 (最高 8分)
   2. 💛 OBV金叉 (黃色)：OBV黃金交叉次數 (最高 8分)
   3. 🟩 總量金叉 (綠色)：總量黃金交叉次數 (最高 8分)
   4. 💗 投信金叉 (粉色)：投信黃金交叉次數 (最高 8分)
   5. 🔴 外資金叉 (紅色)：外資黃金交叉次數 (最高 8分)
   • 總分：最高 8分 × 5項 = 40 分滿格！
   • 實戰判讀：彩虹柱體越高（高於 15~20 分以上）且紅/粉/黃色塊佔比大，代表「外資+投信+量能+價格」全維度大爆發！
-----------------------------------------------------------------------------------------------------------
🌟 【圖二】OBV 量能分析 ✕ 雙星爆發體系
-----------------------------------------------------------------------------------------------------------
追蹤資金暗中建倉與量能爆發的量化指標，搭配「雙星爆發」視覺燈號：
   | 標記圖示 | 標記名稱 | 核心條件 (白話文) | 訊號強度 | 操盤應對 |
   | :---: | :---: | :--- | :---: | :--- |
   | ⭐ | 動能初星 | OBV 淨額突破並站上 5MA 均線 | 🌤️ 轉強 | 短線資金點火，觀察試水溫，建立基本部位 |
   | 🌟 | 巨量金星 | OBV 突破 5MA 的 1.5 倍 或 同時突破 5MA+34MA | 🔥 爆發 | 主力不計代價暴力建倉，重倉順勢追擊主升段 |
-----------------------------------------------------------------------------------------------------------
📈 【圖三】三大法人籌碼 ✕ 實戰總分共振 (雙 Y 軸極致版)
-----------------------------------------------------------------------------------------------------------
1. 左 Y 軸 (綠色)：三大法人籌碼動能 (資金意圖，單位：張數)
   • 法人 5MA (青藍點線)：三大法人 5日移動平均買賣超，代表短線資金態度。
   • 法人 20MA (淺綠點線)：三大法人 20日移動平均買賣超，代表中線布局基調。
   • 法人動能棒 (紅/粉柱)：5MA 減去 20MA 的差值 (資金加速度)。
     - 紅柱向上伸長：法人買盤「加速前進」，大戶積極加碼。
     - 綠柱向下延伸：法人資金撤退或轉為賣超觀望。
2. 右 Y 軸 (亮青色)：實戰總分系統 (技術強度，單位：-100~+100分，獨立放大不壓線)
   • 實戰總分 (亮青發光折線)：將 KD、MACD、MA 排列等多項技術指標自動加權運算成 0~100 分。
   • 5日均分 (粉紅線) & 20日均分 (黃白線)：分數的移動平均線。
   • 分數動能棒 (藍柱)：實戰總分 減去 20日均分 (技術加速度)。
     - 藍柱向上增長：多頭共振強度快速擴張，技術面強烈表態。
-----------------------------------------------------------------------------------------------------------
🎯 操盤手核心看盤要領：【黃金共振 ✕ 頂部背離】
-----------------------------------------------------------------------------------------------------------
📈 黃金共振發動點 (買點確認)：
   當您看到底部的「法人動能棒 (紅柱)」與「分數動能棒 (藍柱)」同時翻正並向上拉長，
   且【圖二】出現代表能量爆發的「🌟 巨量金星」，【圖 1.5】彩虹柱高聳時，代表：
   > 「大戶資金進來了，且多項技術與量能指標同時翻多發動！」
⚠️ 頂部背離警訊 (轉弱落袋)：
   如果股價 (圖一) 還在創新高，但圖三右軸的「實戰總分」開始下滑，
   或者「法人動能棒 (紅柱)」開始收斂甚至翻綠，這就是典型的「指標背離」，
   暗示大戶正在邊拉邊出，短線應果斷分批獲利落袋！
-----------------------------------------------------------------------------------------------------------
⚡ 3 秒速查操盤口訣 (Cockpit Quick Protocol)
-----------------------------------------------------------------------------------------------------------
1看 K棒形態 ➔ (紅K實體 + 頭頂出現 🌟橘星 或 ✨紫金星)
2看 彩虹柱體 ➔ (圖 1.5 柱體衝高 > 15 分，紅/粉色塊佔比大)
3看 OBV雙星  ➔ (圖二出現 🌟巨量金星，OBV 淨額踩在 5MA 上)
4看 雙棒共振 ➔ (圖三紅柱 + 藍柱同時向上擴張)
5看 離場基因 ➔ (對照 StockPersonality_3Exits 離場勝率，鎖定 20MA 或 10MA 或 5MA 防守並列顯示)
===========================================================================================================
✨ 修改亮點與補充說明
整合最新四大圖表：將您最新開發的 【圖 1.5 五維彩虹金叉堆疊圖】 與 【圖三 亮青色雙 Y 軸】 完整納入說明。
三級金星細化：明確標示 ⭐ 黃星（突破5MA）/ 🌟 橘星（突破20MA）/ ✨ 紫光大金星（突破三線） 的視覺意義。
