<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="mapsql3.aspx.vb" Inherits="homesomee.mapsql3"   %>
...
<!--
     ...
     <form id="form1" runat="server">
       ...
       <%--  <br />--%><%-- <div class="container-fluid col-xs-6 col-sm-6 col-md-3">--%>
         <%-- <ul class="nav nav-tabs auto-style1">             
             ...
             <li class="nav-item"><a class="nav-link" href="http://220.134.245.185:8888/androidapp/index.html">回到本機app首頁</a> </li>  
             <li class="nav-item"><a class="nav-link" href="http://220.134.245.185:8888/fishnew5/poemaccesshistory">回到本機網站首頁</a> </li>  
             
         </ul>--%>

        <%--  <ul class="nav nav-tabs auto-style1">
              <li class="nav-item"><a class="nav-link" href="poemaccess.aspx">回首頁</a> </li> 
            <li class="nav-item"><a class="nav-link" href="http://220.134.245.185:8888/androidapp/index.html">本機apk下載(右)</a> </li>            
            <li class="nav-item"><a class="nav-link active" href="mapsql1.aspx">含景點座標(24小時)</a> </li>  
    ...
    <li class="nav-item"><a class="nav-link" href="http://220.135.3.78:8888/androidapp/index.html">回本機首頁</a> </li>
</ul>
          ...
          <div class="container-fluid  leftaddmg">
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-3 cotext-left btn-default">
                    ...
                    <asp:TextBox ID="keyword" runat="server" BackColor="Aqua" CssClass="auto-style5" Font-Size="Smaller" Height="10px" Width="122px" ToolTip="輸入相似字或按右邊的下拉選單輸入,也可以空白" Visible="False">宮</asp:TextBox>
            
                </div>
               <div class="col-xs-6 col-sm-6 col-md-3 tcotext-left  btn-default">
                   
         <asp:DropDownList ID="DropDownList2" class="btn btn-primary " runat="server" AutoPostBack="True" Width="115px" BackColor="#99FF66" Font-Names="標楷體" ForeColor="#003300" Height="10px" Font-Size="Smaller" DataSourceID="SqlDataSource3" DataTextField="name" DataValueField="name" Visible="False">
         </asp:DropDownList>

              </div>

              <div class="col-xs-6 col-sm-6 col-md-3 cotext-left  btn-default">
            <span class="auto-style2"> <asp:Button ID="poem1_stock相似搜尋" runat="server" Height="10px" Text="相似搜尋" 

            Width="153px" CssClass="auto-style5" ToolTip="輸入相似字並列出符合的道館名稱" BackColor="#000066" Font-Size="Smaller" ForeColor="White" Visible="False" />
             </span>           
...
<div class="col-xs-6 col-sm-6 col-md-3 tcotext-left  btn-default">
         ...
         <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" Width="115px" BackColor="Maroon" Font-Names="標楷體" ForeColor="White" Height="10px" Font-Size="Smaller" ToolTip="下拉選擇含有此字的道館" Visible="False">
         </asp:DropDownList>
         </span></span></span></span>
         ...
         <asp:Label ID="Label2" runat="server" Text="x值:" Font-Names="標楷體" Font-Size="Smaller"></asp:Label>

                    <asp:TextBox ID="valuex" runat="server" BackColor="Aqua" CssClass="auto-style5" Font-Size="Smaller" Height="15px" Width="80px" ToolTip="地圖的x軸座標可連動顯示地圖">24.974584</asp:TextBox>

                </div>
              
               <div class="col-xs-6 col-sm-6 col-md-3 tcotext-left  btn-default">

         <asp:Label ID="Label3" runat="server" Text="y值:" Font-Names="標楷體" Font-Size="Smaller"></asp:Label>


                   <asp:TextBox ID="valuey" runat="server" BackColor="Aqua" CssClass="auto-style5" Font-Size="Smaller" Height="15px" Width="80px" ToolTip="地圖的y軸座標可連動顯示地圖">121.547902</asp:TextBox>

              </div>

             <div class="col-xs-6 col-sm-6 col-md-3 tcotext-left  btn-default">
                   <asp:Label ID="Label4" runat="server" Text="景點:" Font-Names="標楷體" Font-Size="Smaller"></asp:Label>

                  <asp:TextBox ID="valuename" runat="server" BackColor="Aqua" CssClass="auto-style5" Font-Size="Smaller" Height="15px" Width="180px" ToolTip="地圖顯示的名稱,可連動顯示地圖">HOME</asp:TextBox>

                    </div>

<div class="col-xs-6 col-sm-6 col-md-3 tcotext-left  btn-default">
              
                   <span class="auto-style2"> <asp:Button ID="Button2" runat="server" Height="10px" Text="依距離" 

            Width="153px" CssClass="auto-style5" ToolTip="依距離所選取的道館的遠近排序" BackColor="#000066" Font-Size="XX-Large" ForeColor="White" Visible="False" />
             </span>  
        ...
        <div class="container-fluid leftaddmg">
            ...
            runat="server" Height="25px" Width="81px" Font-Size="Medium" ToolTip="股票名稱(由選取產生),空白表示列出全部資料,可使用排序及分頁功能(點兩次改變,再點選標題重新列出資料)" BackColor="#CCFFFF" Font-Names="標楷體" ForeColor="#0000CC" Visible="False">10</asp:TextBox>

            </span></span></span> 

              <asp:Button ID="Button87" runat="server" Height="28px" Text="分頁(N筆)" Width="100px" BackColor="#003300" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Visible="False" ToolTip="按到分頁為止,先輸入分頁筆數" />

              &nbsp;<asp:Button ID="Button88" runat="server" Height="28px" Text="不分頁" Width="100px" BackColor="#003300" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Visible="False" ToolTip="按到分頁不見為止" />

              <asp:Button ID="Button89" runat="server" Height="28px" Text="顯示全部" Width="88px" BackColor="#003300" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Visible="False" />

              <asp:Button ID="Button90" runat="server" Height="28px" Text="隱藏部份" Width="98px" BackColor="#003300" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Visible="False" />

              <asp:Button ID="Button92" runat="server" Height="28px" Text="隱藏主表格" Width="103px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Visible="False" ToolTip="不分頁顯示筆數過多,或分頁筆數多時,可按此先隱藏主表格去看圖形,或新增資料時" />

              </span></span></span>
              </div>
                <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" CellPadding="4" Font-Names="標楷體" Font-Size="Large" ForeColor="#333333" GridLines="None" ToolTip="按選取下方地圖會連動並可另顯示衛星地圖,下方的看圖也會連動顯示" AllowPaging="True" PageSize="5" Visible="False">
        ...
        <div class="container-fluid">
          <span class="style1"><span class="auto-style2"><span class="auto-style4"><span class="auto-style1"><span class="auto-style9">
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:pokomonConnectionString %>" SelectCommand="SELECT [name1], [mail1], [word1], [識別碼], [x軸], [y軸] FROM [textmsg]"></asp:SqlDataSource>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false"></script>
        ...
        <asp:DropDownList ID="mapkind" runat="server" Width="180px" AutoPostBack="True" onChange="SetMapType()" BackColor="#FFFF66" Visible="False" >
        ...
        <span class="auto-style10"><span class="auto-style4">
              ...
              <asp:Button ID="Button93" runat="server" Height="28px" Text="顯式主表格" Width="119px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Visible="False" />
       
         &nbsp;</span></span></span></span></span> <span class="auto-style9"><span class="auto-style10"><span class="auto-style4"><span class="auto-style2"><span class="auto-style1"><asp:TextBox   runat="server" id="lng0" name="longitude" Width="116px" BackColor="#FF6666" ToolTip="新增不用輸入,刪除才要" CssClass="auto-style6" Height="27px" style="font-size: large" Visible="False">查詢後輸入</asp:TextBox>
  
         <asp:Button ID="Button94" runat="server" BackColor="Maroon" Height="30px" Text="查詢最後序號" Width="108px" ToolTip="查詢出最後一筆資料的刪除序號(識別碼)" CssClass="auto-style5" ForeColor="White" Font-Names="標楷體" Font-Size="Medium" Visible="False" />

         <asp:Button ID="Button91" runat="server" BackColor="Maroon" Height="30px" Text="刪除壹筆" Width="108px" ToolTip="輸入主鍵號碼(最下面有十筆增加後的資料)" CssClass="auto-style5" ForeColor="White" Font-Names="標楷體" Font-Size="Medium" Visible="False" />
         ...
         &nbsp; <asp:TextBox   runat="server" id="Titles2" name="Titles" BackColor="#66FFFF" ToolTip="空白會顯示全部落title搜尋" TextMode="MultiLine" Width="145px" Height="40px" Visible="False">景點名稱</asp:TextBox>
             <asp:TextBox   runat="server" id="Description2" name="Description" BackColor="#66FFFF" ToolTip="空白會顯示全部落title搜尋" TextMode="MultiLine" Width="224px" Visible="False">景點的地址</asp:TextBox>

         &nbsp;<span class="auto-style1"><span class="style1"><span class="auto-style2"><span class="auto-style9"><span class="auto-style10"><span class="auto-style4"><asp:Button ID="Button83" runat="server" BackColor="#000099" Height="30px" Text="增加到資料庫" Width="117px" ToolTip="點地圖產生x軸 y軸 景點名稱 景點地址,插入主鍵不用輸入會自動產生,上方的資料須按個查詢,否則無法獲取分頁資料" CssClass="auto-style5" ForeColor="White" Font-Names="標楷體" Font-Size="Medium" Visible="False" />
         ...
         <button id="hidemap1btn" onclick="hidemap1()" hidden="hidden">隱藏下方地圖</button> <button id="nowaddress" onclick="initMapnowaddress()" hidden="hidden">現在位置</button><button id="nowaddress1" onclick="getLocation()" hidden="hidden">現在位置2</button>

                     <%--<div  class="leftaddmg container-fluid float-left" id="map不在表頭1"style="width: 25%; height:25%">  </div>--%>
 ...
 <%-- <br />
       ...
       <br />
              <asp:Label ID="Label9" runat="server" Text="刪除可看此序號(刪除序號是識別碼)" CssClass="auto-style7" Visible="False"></asp:Label>              
         <asp:GridView ID="GridView15" runat="server" Font-Size="Medium" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" PageSize="3" Visible="False">
          ...
          <br />
         <asp:Label ID="Label5" runat="server" Text="編輯或刪除用,上面新增此地不會顯示須重新整理才會更新" CssClass="auto-style8" Visible="False"></asp:Label>              
         <asp:GridView ID="GridView16" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="識別碼" DataSourceID="SqlDataSource4" Font-Names="標楷體" Font-Size="Large" ForeColor="#333333" GridLines="None" PageSize="5" Visible="False">
