<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="YouBikeTP1.aspx.vb" Inherits="homesomee.YouBikeTP1"  maintainscrollpositiononpostback="true" %>
...
<!--
    ...
    <li class="nav-item"><a class="nav-link" href="http://220.135.3.78:8888/androidapp/index.html">回區城首頁</a> </li>
         ...
         <%-- </div>--%>
        <br />
        &nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Font-Names="標楷體" Font-Size="X-Large" ForeColor="#CC0000" Text="大台北地區YouBike設置地點" ToolTip="只有台北市跟新北市"></asp:Label>
          ...
          <div class="container-fluid  leftaddmg">
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-3 cotext-left btn-default">
                    ...
                    <asp:TextBox ID="keyword" runat="server" BackColor="Aqua" CssClass="auto-style5" Font-Size="X-Large" Height="50px" Width="122px" ToolTip="輸入相似字或按右邊的下拉選單輸入">新店區</asp:TextBox>
...
<div class="col-xs-6 col-sm-6 col-md-3 tcotext-left  btn-default">
         ...
         <asp:Label ID="Label2" runat="server" Text="x值:" Font-Names="標楷體" Font-Size="XX-Large"></asp:Label>
                    ...
                    <asp:TextBox ID="valuex" runat="server" BackColor="Aqua" CssClass="auto-style5" Font-Size="X-Large" Height="50px" Width="193px" ToolTip="地圖的x軸座標可連動顯示地圖">24.974584</asp:TextBox>
         ...
         <asp:Label ID="Label3" runat="server" Text="y值:" Font-Names="標楷體" Font-Size="XX-Large"></asp:Label>
                   ...
                   <asp:TextBox ID="valuey" runat="server" BackColor="Aqua" CssClass="auto-style5" Font-Size="X-Large" Height="50px" Width="190px" ToolTip="地圖的y軸座標可連動顯示地圖">121.547902</asp:TextBox>

              </div>

             <div class="col-xs-6 col-sm-6 col-md-3 tcotext-left  btn-default">
                   <asp:Label ID="Label4" runat="server" Text="名稱:" Font-Names="標楷體" Font-Size="XX-Large"></asp:Label>

                  <asp:TextBox ID="valuename" runat="server" BackColor="Aqua" CssClass="auto-style5" Font-Size="X-Large" Height="50px" Width="190px" ToolTip="地圖顯示的名稱,可連動顯示地圖">HOME</asp:TextBox>
...
<div class="col-xs-6 col-sm-6 col-md-3 tcotext-left  btn-default">
            ...
            Width="153px" CssClass="auto-style5" ToolTip="1.選出你的比較的基準資料(相似搜尋再按選取讓資料在下方的x值及y值中出現 2.選出你要重新計算的範圍,一樣用相似搜尋讓資料出現在下方的表格內,但要先點選不分頁再搜尋,便能將全部要更新的資料都全部顯示出來 3.最後按依距離按鍵來更新資料 4.更新後的資料便會依原基準資料由近至遠來呈現 5.不要用全部資料來作更新,可能時間不夠會逾時" BackColor="#000066" Font-Size="XX-Large" ForeColor="White" />
             </span>  
        ...
        <span class="auto-style10">(<asp:TextBox ID="totolpage" 
            ...
            runat="server" Height="25px" Width="81px" Font-Size="Medium" ToolTip="股票名稱(由選取產生),空白表示列出全部資料,可使用排序及分頁功能(點兩次改變,再點選標題重新列出資料)" BackColor="#CCFFFF" Font-Names="標楷體" ForeColor="#0000CC">10</asp:TextBox>
              ...
              <asp:Button ID="Button87" runat="server" Height="28px" Text="分頁(N筆)" Width="100px" BackColor="#003300" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Visible="True" />

              )<asp:Button ID="Button88" runat="server" Height="28px" Text="不分頁" Width="85px" BackColor="#003300" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Visible="True" />

              <asp:Button ID="Button89" runat="server" Height="28px" Text="顯示全部欄" Width="95px" BackColor="#003300" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Visible="True" />

              <asp:Button ID="Button90" runat="server" Height="28px" Text="隱藏部份欄" Width="98px" BackColor="#003300" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Visible="True" />
              ...
              <asp:Button ID="Button92" runat="server" Height="28px" Text="隱藏主表格" Width="103px" BackColor="Maroon" Font-Names="標楷體" Font-Size="Medium" ForeColor="White" Visible="True" ToolTip="不分頁顯示筆數過多,或分頁筆數多時,可按此先隱藏主表格去看圖形,或新增資料時" />
                ...
                <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" CellPadding="4" Font-Names="標楷體" Font-Size="Large" ForeColor="#333333" GridLines="None" ToolTip="按選取下方地圖會連動並可另顯示衛星地圖,下方的看圖也會連動顯示" AllowPaging="True" PageSize="5" CssClass="auto-style4">
                    <AlternatingRowStyle BackColor="White" />
                    <PagerTemplate>
    <asp:Label ID="Labe222" runat="server" Text="請選擇頁數:"></asp:Label>
    <asp:DropDownList ID="DropDownListtwo" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownListtwo_SelectedIndexChanged" Font-Size="Large" Width="50">
    </asp:DropDownList>
    <asp:Label ID="Labelpagetwo" runat="server" Text="頁"></asp:Label>
    <br />  
</PagerTemplate>
                    <Columns>
                    ...
                    <PagerStyle BackColor="#FFCC66" ForeColor="#333333" HorizontalAlign="Center" Font-Size="X-Large" VerticalAlign="Middle" Width="400px" />
        ...
        <div class="container-fluid">
          <span class="style1"><span class="auto-style2"><span class="auto-style4"><span class="auto-style1"><span class="auto-style9">
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:pokomonConnectionString %>" SelectCommand="SELECT [name1], [mail1], [word1], [識別碼], [x軸], [y軸] FROM [textmsgyb]"></asp:SqlDataSource>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false"></script>
        ...
        <span class="auto-style10"><span class="auto-style4">
         ...
         &nbsp;</span></span></span></span></span><span class="auto-style9"><span class="auto-style10"><span class="auto-style4"><span class="auto-style5"><span class="auto-style1">(刪除主鍵:</span></span><span class="auto-style2"><span class="auto-style1"><asp:TextBox   runat="server" id="lng0" name="longitude" Width="116px" BackColor="#FF6666" ToolTip="新增不用輸入,刪除才要" CssClass="auto-style6" Height="27px">查詢後輸入</asp:TextBox>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <br />
         ...
         <br/>
          ...
          <asp:GridView ID="GridView1" runat="server"  AllowPaging="True" AllowSorting="True" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" ToolTip="去看圖會連動顯示地圖,並可新增修改資料,最後建檔的資料顯示在最前面">
                          ...
                          <PagerTemplate>
                              ...
                              <asp:DropDownList ID="DropDownListone" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownListone_SelectedIndexChanged" Font-Size="Large" Width="50">
                              </asp:DropDownList>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ...
          <span class="style1"><span class="auto-style2"><span class="auto-style4"><span class="auto-style1"><span class="auto-style9">
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:pokomonConnectionString %>" SelectCommand="SELECT DISTINCT LEFT (name1, 1) AS name FROM textmsgyb ORDER BY name"></asp:SqlDataSource>
                    </span>
         <br />
         ...
         <asp:GridView ID="GridView16" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="識別碼" DataSourceID="SqlDataSource4" Font-Names="標楷體" Font-Size="Large" ForeColor="#333333" GridLines="None" PageSize="5">
             ...
             <Columns>
                 ...
                 <asp:BoundField DataField="x軸" HeaderText="x軸" SortExpression="x軸" />
                 <asp:BoundField DataField="y軸" HeaderText="y軸" SortExpression="y軸" />
                 <asp:BoundField DataField="x軸距離" HeaderText="x軸距離" SortExpression="x軸距離" />
                 <asp:BoundField DataField="y軸距離" HeaderText="y軸距離" SortExpression="y軸距離" />
         ...
         <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:pokomonConnectionString %>" DeleteCommand="DELETE FROM [textmsgyb] WHERE [識別碼] = @識別碼" InsertCommand="INSERT INTO [textmsgyb] ([name1], [mail1], [word1], [時間戳記], [x軸], [y軸], [x軸距離], [y軸距離], [x軸絶對距離], [y軸絶對距離], [x加y]) VALUES (@name1, @mail1, @word1, @時間戳記, @x軸, @y軸, @x軸距離, @y軸距離, @x軸絶對距離, @y軸絶對距離, @x加y)" SelectCommand="SELECT * FROM [textmsgyb] ORDER BY [識別碼] DESC" UpdateCommand="UPDATE [textmsgyb] SET [name1] = @name1, [mail1] = @mail1, [word1] = @word1, [時間戳記] = @時間戳記, [x軸] = @x軸, [y軸] = @y軸, [x軸距離] = @x軸距離, [y軸距離] = @y軸距離, [x軸絶對距離] = @x軸絶對距離, [y軸絶對距離] = @y軸絶對距離, [x加y] = @x加y WHERE [識別碼] = @識別碼">
             <DeleteParameters>
